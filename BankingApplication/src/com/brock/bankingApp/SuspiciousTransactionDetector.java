...
public class SuspiciousTransactionDetector {
    ...
    private static int checkSuspiciousCriteria(Transaction transaction, int recentTransactionsCount) {
    ...
    public static boolean isTransactionSuspicious(Transaction transaction, int recentTransactionsCount) {
